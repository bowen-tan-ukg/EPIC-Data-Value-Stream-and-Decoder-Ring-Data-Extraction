...
#the variables below should be added to config file so that we don't have to trouch this code once developed 
dotenv_path=find_dotenv()
load_dotenv(dotenv_path)
url_base = os.getenv("url_base_valuestream")
api_key = os.getenv("api_key_valuestream")
...
#normalize json data
df = pandas.json_normalize(responseData,'value_stream')
#print(df)
...
df.to_sql(name='valuestream',con=engine,index=False,if_exists='fail')
